...
class SkillImpl(Node):
    ...
    def __init__(self) -> None:
        """Construct the node."""
        super().__init__('skill_basic_say')
        ...
        self.get_logger().info('Skill basic_say started, but not yet configured.')
    ...
    def on_configure(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill basic_say is configured, but not yet active")
    ...
    def on_activate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill basic_say is active and running")
    ...
    def on_deactivate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill basic_say is stopped (inactive)")
        return super().on_deactivate(state)

    def on_shutdown(self, state: State) -> TransitionCallbackReturn:
        self.get_logger().info('Shutting down basic_say skill.')
        ...
        self.get_logger().info("Skill basic_say finalized.")
        return TransitionCallbackReturn.SUCCESS
    ...
    def publish_diagnostics(self):
        ...
        msg = DiagnosticStatus(
            ...
            name="/skills/say",
            message="skill basic_say is running",
            values=[
                KeyValue(key="Module name", value="basic_say"),
